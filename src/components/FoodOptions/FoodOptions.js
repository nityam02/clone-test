...
const FoodOptions = () => {
  ...
  const resDetail = useFetch("https://raw.githubusercontent.com/euhidaman/Fake_APIs/main/restaurant_details.json");
      ...
      <div className="text-gray-400  body-font">
        <div className="container food-body px-10 py-10 md:mx-auto">
          <div className="flex flex-wrap md:-m-4 md:pl-6 foods-container">
            {resDetail?.foodDetails?.map((food, index) => (
              <div
                key={index}
                className="w-full mb-4 p-2 transform transition duration-200 rounded-lg hover:scale-105 hover:shadow-lg "
              >
                <div className="h-full flex flex-col items-center text-center food-wrapper">
                  <img
                    alt="test"
                    className=" rounded-lg w-full h-60 object-cover object-center mb-2 " 
                    src={food.hotelUrl}
                  />
                  ...
                  <div className="w-full">
                    ...
                    <div className="w-full">
                      <div 
                      className="flex justify-between py-1 mb-3">
